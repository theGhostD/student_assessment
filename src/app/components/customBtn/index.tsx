...
const CustomButton = ({
  ...
  return (
    <button
      ...
      type="submit"
      className={`
        w-full flex justify-center items-center gap-2 rounded-full relative overflow-hidden group hover:text-[#090A0B] transition-colors duration-300 
        ${
          isSmall
         ...
         ${
           variant === "yellowTheme" && Boolean(!disable && !isloading)
             ...
             : "bg-[#212C58]/[0.4] cursor-not-allowed "
         }`}
      onClick={() => handleSubmit()}
    >
      {!Boolean(disable || isloading) && (
